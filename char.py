...
def submit():
    ...
    label5.config(text="There are " + str(no_of_chars) + ' characters ' + ' and '
                  +str(no_of_words) + " words")
...
text1=Text(win, width=110,relief=RAISED,height=20,takefocus=0,font=("Arial",15),
           fg='grey',wrap=WORD,spacing1=1)
